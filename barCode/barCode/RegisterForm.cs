...
namespace RegistrationCode
{
    public partial class RegisterForm : Form
    {
        ...
        {
            //select distinct net_address from master.dbo.sysprocesses where program_name like 'SQLAgent%' and hostname=SERVERPROPERTY('MachineName') and net_address<>'000000000000'
